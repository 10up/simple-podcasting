...
<form method="POST" action="">
	<div class="simple-podcasting__onboarding-body simple-podcasting__onboarding-body--step-1">
		...
		<div class="simple-podcasting__setting">
			...
			<div class="simple-podcasting__setting-input"><textarea name="podcast-description" id="simple-podcasting-podcast-description" rows="5" required></textarea></div>
		...
		<!-- Cover image -->
		<div class="simple-podcasting__setting">
			<input type="hidden" name="podcast-cover-image-id" id="simple-podcasting-podcast-cover-image-id" value="" required>
