...
function onboarding_action_handler() {
	if ( ! isset( $_POST['simple-podcasting-create-show-nonce-field'] )
	|| ! wp_verify_nonce( $_POST['simple-podcasting-create-show-nonce-field'], 'simple-podcasting-create-show-action' )
	) {
		return;
	}
